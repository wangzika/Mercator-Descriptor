...
def get_gt_sens_poses13(fpath_gt_sens_poses):
    """
...
def get_points_ours2(fp_gt_sens_poses, fp_outcome):
    ...
    with open(fp_outcome, "r") as f1:
        ...
        for i in range(est.shape[0]):
            ...
            pr_points.append([tp / (tp + fn if tp + fn > 0 else 1 ), tp / (tp + fp  if tp + fp > 0 else 1), est[i, 3]])
...
if __name__ == "__main__":
    file_gt_sens_poses = "/home/xdh/下载/dataset/poses/08.txt"
    # file_outcome = "/home/xdh/SLAM/std_ws/src/STD/res_out/wzb/loopres-kitti00_generated.txt"
    file_outcome = "/home/xdh/SLAM/bow3d_ws/src/BoW3D/res_bow3d/outcome-kitti08_generated.txt"  
    # file_outcome = "/home/xdh/SLAM/LiDAR-Iris/iris_res/iris_res00.txt"  /home/xdh/SLAM/LiDAR-Iris/iris_res/new/iris_res00.txt
    file_outcome = "/home/xdh/SLAM/LiDAR-Iris/iris_res/new/iris_res00.txt"  
